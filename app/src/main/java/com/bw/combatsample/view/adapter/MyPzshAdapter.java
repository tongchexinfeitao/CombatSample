...
public class MyPzshAdapter extends RecyclerView.Adapter<MyPzshAdapter.MyViewHolder> {


    private List<Lawyer.ResultBean.PzshBean.CommodityListBeanX> commodityList;

    public MyPzshAdapter(List<Lawyer.ResultBean.PzshBean.CommodityListBeanX> commodityList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        // TODO: 2019/12/6 绑定数据
        Lawyer.ResultBean.PzshBean.CommodityListBeanX commodityListBeanXX = commodityList.get(i);
